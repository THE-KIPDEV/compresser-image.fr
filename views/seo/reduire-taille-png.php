...
<section class="seo-content">
    <div class="container container-sm">
        ...
        <p>Deux approfondissements si votre besoin est plus précis : <a href="<?= url('/reduire-taille-png-sans-perte') ?>">réduire un PNG sans perte</a> (ce que « sans perte » veut vraiment dire, et quand la ré-indexation ne change pas un pixel), et <a href="<?= url('/reduire-taille-png-windows') ?>">réduire un PNG sous Windows</a> (Paint, l'appli Photos et pourquoi elles ne compressent pas vraiment).</p>
